...
python :: ----------inserted code from G:\Dropbox (Personal)\Apps\folder.repo\trunk\rebuilt.addons\update_repo.py----------------------------------------
#!/usr/bin/env python
r"""
...
:: ----------inserted code region ends here---------------------------------------------------------------------------

python :: ----------inserted code from G:\Dropbox (Personal)\Apps\folder.repo\trunk\rebuilt.addons\update-directory-structure.py----------------------------------------
#!/usr/bin/env python
"""
...
def create_md5(fname):
    ...
    with open(fname, "wb") as f:
        for chunk in iter(lambda: f.write(4096), b""):
