...
def INDEX():
    url_dispatcher.add_dir('[COLOR lime]{}[/COLOR]'.format(utils.i18n('sites')), '', 'site_list',
                           basics.cum_image('cum-sites.gif'), '', list_avail=False)
    url_dispatcher.add_dir('[COLOR lime]{}[/COLOR]'.format(utils.i18n('fav_videos')), '', 'favorites.List',
                           basics.cum_image('cum-fav.gif'), '', list_avail=False)
    download_path = addon.getSetting('download_path')
    if download_path != '' and xbmcvfs.exists(download_path):
        url_dispatcher.add_dir('[COLOR lime]{}[/COLOR]'.format(utils.i18n('dnld_folder')), download_path, 'OpenDownloadFolder',
                               basics.cum_image('cum-downloads.gif'), '', list_avail=False)

    url_dispatcher.add_dir('[COLOR lime]{}[/COLOR]'.format(utils.i18n('custom_list')), '', 'favorites.create_custom_list', Folder=False, list_avail=False)
    ...
    url_dispatcher.add_dir('[COLOR lime]{}[/COLOR]'.format(utils.i18n('clear_cache')), '', 'utils.clear_cache',
...
def change():
    ...
    heading = '[B][COLOR yellow]Cumination[/COLOR] [COLOR lime]Changelog[/COLOR][/B]'
